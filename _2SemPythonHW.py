...
n=10
while n:
    n-=1#условия выхода из цикла
    rand_num=int(round(time.time())*1000)# функция времени
    print(rand_num)
    #rand_num*=int(rand_num)#выбираем целое значение, умножаем дробное на целое, чтоб избавиться от целой части
    n=int(input())